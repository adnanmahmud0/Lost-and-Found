...
const AddItem = () => {
    ...
    const handleAddItem = (e) => {
        ...
        console.log(postType, thumbnail, title, category, description, location, xDateLost, userName, email);
            ...
            <form onSubmit={handleAddItem}>
                <div className="md:grid md:grid-cols-2 gap-8">
                    ...
                    <div>
                        ...
                        <DatePicker id='location' name='location' selected={dateLost} onChange={(date) => setDateLost(date)} className="bg-gray-100 w-full text-gray-800 text-sm px-4 py-3.5 rounded-md focus:bg-transparent outline-blue-500 transition-all" />
                    </div>
                    <div>
